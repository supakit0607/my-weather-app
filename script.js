const apiKey = '703724cb4c6a5168dfe9c96a8e2e201a';
...
function updateBackground(temp, iconCode) {
    ...
    if (isNight || hour >= 18 || hour <= 6) {
        body.style.background = 'linear-gradient(#0f2027, #203a43, #09506fff)'; // กลางคืน
    } else if (temp > 30) {
        body.style.background = 'linear-gradient(#ff7300, #edde07ff)'; // ร้อน
    } else if (temp < 20) {
        body.style.background = 'linear-gradient(#2b5876, #2602a8ff)'; // หนาว
    } else {
        body.style.background = 'linear-gradient(#56ccf2, #cb1d11ff)'; // ปกติ
    }
}
